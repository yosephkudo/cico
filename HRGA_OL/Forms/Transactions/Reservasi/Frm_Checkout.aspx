<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Forms/SiteMaster/HrgaOl.Master" CodeBehind="Frm_Checkout.aspx.vb" Inherits="HRGA_OL.Frm_Checkout" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="form-horizontal">
		...
		<div class="col-sm-7">
            <iframe
                src="http://bekbsqrp401:3000/public/question/e39f1c46-df10-42b8-97c6-2da27cbb1e9a"
                frameborder="0"
                width="640"
                height="520"
                allowtransparency
