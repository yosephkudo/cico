...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="form-horizontal">
				...
				<div class="box-body">
					...
					<script type="text/javascript">
            		    $(document).ready(function () {
            		        // Set focus to the txt_nrp TextBox
            		        $('#<%= txt_nrp.ClientID %>').focus();
            		    });
            		</script>
							...
							<ContentTemplate>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<asp:SqlDataSource runat="server" ID="ds_company" ConnectionString='<%$ ConnectionStrings:DB_GSISConn %>' SelectCommand="SELECT NULL COMPANY UNION SELECT COMPANY FROM VW_COMPANY"></asp:SqlDataSource>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<asp:SqlDataSource runat="server" ID="ds_kamar" ConnectionString='<%$ ConnectionStrings:DB_GSISConn %>' SelectCommand="SELECT NULL AS PID_DETAIL_MESS, NULL AS NAMA_KAMAR UNION SELECT PID_DETAIL_MESS, NAMA_KAMAR FROM dbo.CUFN_GET_KAMAR_READY(@NRP, @AWAL, @AKHIR,@GEDUNG)">
											<SelectParameters>
		...
		<div class="col-sm-7">
        <iframe
            src="http://bekbsqrp401:3000/public/question/d2f8f863-8ccd-48d3-a2ea-5b88fc863cb8"
            frameborder="0"
            width="640"
            height="530"
            allowtransparency
